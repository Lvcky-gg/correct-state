export const filterState = (state) => {
    ...
    if (state.toLowerCase().startsWith('new h')) return 'New Hampshire'
    if (state.toLowerCase().startsWith('new j')) return 'New Jersey'
    if (state.toLowerCase().startsWith('new y')) return 'New York'
    if (state.toLowerCase().startsWith('north c')) return 'North Carolina'
    if (state.toLowerCase().startsWith('north d')) return 'North Dakota'
    ...
    if (state.toLowerCase().startsWith('rho')) return 'Rhode Island'
    if (state.toLowerCase().startsWith('south c')) return 'South Carolina'
    if (state.toLowerCase().startsWith('south d')) return 'South Dakota'
    ...
    if (state.toLowerCase().startsWith('west')) return 'West Virginia'
    ...
    for(let i = 0; i< 18; i++){
        ...
        if (NewHampshire[i] && state.toLowerCase() === NewHampshire[i].toLowerCase()) return 'New Hampshire'
        if (NewJersey[i] && state.toLowerCase() === NewJersey[i].toLowerCase()) return 'New Jersey'
        if (NewMexico[i] && state.toLowerCase() === NewMexico[i].toLowerCase()) return 'New Mexico'
        if (NewYork[i] && state.toLowerCase() === NewYork[i].toLowerCase()) return 'New York'
        if (NorthCarolina[i] && state.toLowerCase() === NorthCarolina[i].toLowerCase()) return 'North Carolina'
        if (NorthDakota[i] && state.toLowerCase() === NorthDakota[i].toLowerCase()) return 'North Dakota'
        ...
        if (RhodeIsland[i] && state.toLowerCase() === RhodeIsland[i].toLowerCase()) return 'Rhode Island'
        if (SouthCarolina[i] && state.toLowerCase() === SouthCarolina[i].toLowerCase()) return 'South Carolina'
        if (SouthDakota[i] && state.toLowerCase() === SouthDakota[i].toLowerCase()) return 'South Dakota'
        ...
        if (WestVirginia[i] && state.toLowerCase() === WestVirginia[i].toLowerCase()) return 'West Virginia'
